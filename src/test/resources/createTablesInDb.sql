...
alter table if exists car add constraint FK32u9f6dnu1ti5407ykprhnle4
foreign key (parking_slot_id) references parking_slot;
alter table if exists car_driver add constraint FKrnrbra75siihkc0pxstlyowgx
foreign key (car_id) references car;
alter table if exists car_driver add constraint FKqfgeoqa4bx2fhoa3bhwtijxb4
foreign key (driver_id) references driver;
alter table if exists parking_slot add constraint FKhbp9paljf4v8starvmf2996u6
foreign key (parking_garage_id) references parking_garage;